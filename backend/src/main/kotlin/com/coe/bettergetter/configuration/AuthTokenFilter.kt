...
class AuthTokenFilter constructor(private val userService: UserService, private val jwtUtils: JwtUtils): OncePerRequestFilter() {
    ...
    override fun doFilterInternal(
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                val userDetails: UserDetails = userService.findUserByEmail(username)!!
